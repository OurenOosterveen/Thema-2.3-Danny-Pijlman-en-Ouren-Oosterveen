...
public class DobbelsteenMVC extends JApplet
{
	...
	public void init()
	{
        ...
        worpenView = new WorpenView();
        worpenView.setBackground(Color.white);
        getContentPane().add(worpenView,BorderLayout.EAST);
        ...
        model.addActionListener(worpenView);
